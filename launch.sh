...
if ! [[ -f "$SERVER_FILE_NAME" ]]; then
    echo "First run detected. Installing All the Mods 11..."
...
ATM11_INSTALL_ONLY=true ./startserver.sh
...
echo "Starting All the Mods 11 server (NeoForge ${NEOFORGE_VERSION})..."
